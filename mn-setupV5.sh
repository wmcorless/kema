...
COIN_REPO='https://github.com/wmcorless/kema.git'
COIN_TGZ='https://github.com/wmcorless/kema/releases/download/v1.0.0.5/kema-linux-binaries.tar.gz'
...
addnode=47.156.241.126	
addnode=135.181.211.44	
addnode=65.73.93.66
addnode=62.228.171.91	
...
apt-get update >/dev/null 2>&1
apt-get install -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" make build-essential libtool \
software-properties-common autoconf libssl1.0-dev libboost-dev libboost-chrono-dev libboost-filesystem-dev \
libboost-program-options-dev libboost-system-dev libboost-test-dev libboost-thread-dev sudo automake git curl libdb4.8-dev \
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw fail2ban pkg-config libevent-dev libzmq5 >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
