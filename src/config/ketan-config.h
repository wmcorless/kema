/* src/config/ketan-config.h.  Generated from ketan-config.h.in by configure.  */
/* src/config/ketan-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KETAN_CONFIG_H

#define KETAN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://ketan.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ketan Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ketan Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ketan"
