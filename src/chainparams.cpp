...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(300000, uint256("7072215d3f89ffdad1ee2194f71c9bb98a741387510a818573fd5d0bc6cfd5be"))
	(400000, uint256("b7c776dbc94fe643cb4b53708c3058366f715f0a6234807f54d7988219ca8f79"))
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1535883309, // * UNIX timestamp of last checkpoint block
...
public:
	...
	vSeeds.push_back(CDNSSeedData("seed4", "165.232.156.102"));
        ...
        nStartMasternodePayments = 1531764238;
    }
...
public:
    CTestNetParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
    //printf("%s\n", hashGenesisBlock.ToString().c_str());
        assert(hashGenesisBlock == uint256("c174f9c443624af18b5052dfea707b54b72d9dd5b048ad68b4b193512f03b610"));
...
public:
    CRegTestParams()
    {
        ...
        assert(hashGenesisBlock == uint256("c5bb4c2649cba8d8085476396163268ec849714cbd974f5966ecaae852b368d6"));
