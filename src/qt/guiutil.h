...
/** Utility functions used by the KETAN Qt UI.
 */
namespace GUIUtil
{
...
// Render KETAN addresses in monospace font
...
// Parse "ketan:" URI into recipient object, return true on successful parsing
