...
RESOURCES += src/qt/ketan.qrc src/qt/ketan_locale.qrc

TRANSLATIONS += src/qt/locale/ketan_bg.ts \
                src/qt/locale/ketan_de.ts \
                src/qt/locale/ketan_en.ts \
                src/qt/locale/ketan_es.ts \
                src/qt/locale/ketan_fi.ts \
                src/qt/locale/ketan_fr.ts \
                src/qt/locale/ketan_it.ts \
                src/qt/locale/ketan_ja.ts \
                src/qt/locale/ketan_pl.ts \
                src/qt/locale/ketan_pt.ts \
                src/qt/locale/ketan_ru.ts \
                src/qt/locale/ketan_sk.ts \
                src/qt/locale/ketan_sv.ts \
                src/qt/locale/ketan_vi.ts \
                src/qt/locale/ketan_zh_CN.ts \
                src/qt/locale/ketan_zh_TW.ts
