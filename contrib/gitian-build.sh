...
VERSION=
commit=false
url=https://github.com/wmcorless/kema
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/wmcorless/kema
...
#    git clone https://github.com/wmcorless/kema.SIGS.git
